...
public class Q6SortPixelDesc {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			System.out.println("Image Pixels in descending using MergeSort");
			MergeSortDesc mergeSortObj = new MergeSortDesc();
			 ...
			 */
			System.out.println("Image Pixels in descending using heapSort");
			HeapSortDesc heapSortObj = new HeapSortDesc();
