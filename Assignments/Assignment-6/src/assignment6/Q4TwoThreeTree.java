...
class Q4DataNode {
	...
	public Q4DataNode(double dd) // constructor
	{
		dData = dd;
	}
...
class Q4Node {
	...
	private Q4Node parent;
	private Q4Node childArray[] = new Q4Node[ORDER];
	private Q4DataNode itemArray[] = new Q4DataNode[ORDER - 1];

	public void connectChild(int childNum, Q4Node child) {
	...
	public Q4Node disconnectChild(int childNum) {
		Q4Node tempNode = childArray[childNum];
		childArray[childNum] = null;
		return tempNode;
	}

	public Q4Node getChild(int childNum) {
		return childArray[childNum];
	}

	public Q4Node getParent() {
		return parent;
	}
	...
	public Q4DataNode getItem(int index) // get DataNode at index
	{
	...
	public int insertItem(Q4DataNode newItem) {
	...
	public Q4DataNode removeItem() {

		Q4DataNode temp = itemArray[numItems - 1];
...
class Q4Tree234 {
	...
	private Q4Node root = new Q4Node();
	...
	{
		Q4Node curNode = root;
		Q4DataNode tempItem = new Q4DataNode(dValue);
	...
	public void split(Q4Node thisNode) {

		Q4DataNode itemB, itemC;
		Q4Node parent, child2, child3;
		int itemIndex;
		...
		for (int j = n - 1; j > itemIndex; j--) {
			Q4Node temp = parent.disconnectChild(j);
	...
	public Q4Node getNextChild(Q4Node theNode, double theValue) {
	...
	private void recDisplayTree(Q4Node thisNode, int level, int childNumber) {
		System.out.print("level=" + level + " child=" + childNumber + " ");
		thisNode.displayNode();

		int numItems = thisNode.getNumItems();
		for (int j = 0; j < numItems + 1; j++) {
			Q4Node nextNode = thisNode.getChild(j);
			if (nextNode != null) {
