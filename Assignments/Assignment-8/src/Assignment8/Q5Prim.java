...
public class Q5Prim {
	 ...
	 */
	private Q5SimpleWeightedGraph graph;

	/**
	 * Key value of each Vertex in the graph Infinite will be represented with
	 * Integer.MAX_VALUE = 2^31 + 1
	 */
	private int[] keys;

	/**
	 * For each Vertex it holds its predecessor To represent null I used: '!'
	 */
	private char[] predecessor;

	/**
	 * The Priority Queue used by the algorithm Since we're using a low level
	 * implementation of the graph this has been adapted and implemented with a
	 * HashSet
	 */
	private HashSet<Character> Q;

	/**
	 * Gets an instance of the graph Initializes 'keys', 'predecessor', and 'Q'
	 */
	public Q5Prim() {
		graph = Q5SimpleWeightedGraph.getGraphInstance();
		...
		/**
		 * All Vertices are added to Q Every Vertex will start having a key of infinite
	...
	/**
	 * Given a char representing a Vertex name it returns its position in an array
	 * (EG 3 = 'd')
	 * 
	...
	/**
	 * A simulation of a "poll" of a priority queue. It removes and returns the
	 * smallest element in Q
	 * 
	 * @param Q    The Set containing Vertices (all of them at the very first
