...
public class Knapsack_unbounded1_dp {
	...
	/*
	 * ======================================================== M_dp(W) = max value
	 * achieved by knapsack with capacity W
	 * ========================================================
	 */
	static int M_dp(int[] v, int[] w, int W) {
		...
		for (C = 1; C <= W; C++) {
			...
			/*
			 * --------------------------------------------- Use the solutions to the
			 * smaller problems to solve original problem
			 * ---------------------------------------------
			 */
			for (i = 0; i < v.length; i++) {
				if (C >= w[i])
	...
	public static void main(String[] args) {
		...
		C = 24; // Around 53 it starts to slow...
		r = M_dp(v, w, C);

		System.out.println("Max value packed in backpack of capacity " + C + " = " + r);
	}
