...
public class Q9_BTree {
	...
	public void insert(Q9_BTree t, char key) {
	...
	public void print(BNode n) {
		for (int i = 0; i < n.count; i++) {
			System.out.print(Character.toString((char) n.getValue(i)) + " ");// this part prints root node
		}
	...
	public void SearchPrintNode(Q9_BTree T, int x) {
	...
	public void deleteKey(Q9_BTree t, int key) {
	...
	public static void main(String[] args) {
		...
		Q9_BTree tree = new Q9_BTree(n);// B-Tree Tree with order N is created.

		// Initial Values are added to the Tree.. The user and Input any number of
		// Values.
