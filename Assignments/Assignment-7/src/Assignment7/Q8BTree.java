...
public class Q8BTree {
	...
	public void insert(Q8BTree t, int key) {
	...
	public void SearchPrintNode(Q8BTree T, int x) {
	...
	public void deleteKey(Q8BTree t, int key) {
	...
	public static void main(String[] args) {
		...
		Q8BTree tree = new Q8BTree(n);// B-Tree Tree with order N is created.
